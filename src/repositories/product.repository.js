...
class ProductRepository {
    async agregarProducto({ winery, wine, location, price, image, code, stock, category, thumbnails }) {
        try {
            if (!winery || !wine || !location || !price || !image || !code || !stock || !category || !thumbnails) {
